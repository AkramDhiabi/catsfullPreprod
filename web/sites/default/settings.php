 ...
 * @endcode
 */
# $config_directories = [CONFIG_SYNC_DIRECTORY => 'sites/default/files/configsync'];
 ...
 * @endcode
 */
$settings['hash_salt'] = 'B7re5Hfxz0udr6aWzBZHXmm2EVkxwNMhPtsUAuDqUExRZoXIujtv5jEpRT7567z95IgMVvYe5Q';
$settings['trusted_host_patterns'] = [
  '^levillagebyca\.local$',
  '^levillagefull\.local$',
  '^www\.levillagebyca\.local$',  
];
...
$config_directories['sync'] = 'deploy/sync';
