...
(function ($) {
   ...
   /*            */
        $('.slick__slide').hover(
    function(){
        $('.slick__slide > .village-title-wrapper').addClass('hidden');
    },
    function(){
        $('.slick__slide >.village-title-wrapper').removeClass('hidden');
    },
        function(){
        $('.slick__slide > .village-title-wrapper').children().addClass('hidden');
    },
    function(){
        $('.slick__slide >.village-title-wrapper').children().removeClass('hidden');
    }, 
   /*           */
    function () {
