...
(function ($) {
    $(document).ready(function () {
        ...
        .find('.views-row')
        .click(function(){
          $(this).find('.fiche').toggle();
        });    

    $(".leaflet-marker-icon").click(function(){
          var mapVillageName= $(this).attr('title');
          var cardVillageName =  $('.fiche-title').find('span').attr('class').text();
          if(mapVillageName === cardVillageName) {
            alert(mapVillageName + ' IS equal with ' + cardVillageName)
            $('.fiche-title').parent().parent().parent().toggle();
          }else{alert(mapVillageName + ' no equal with ' + cardVillageName )}
        });    
