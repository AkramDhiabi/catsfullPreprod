...
(function ($) {
   $(document).ready(function () {
    /**  Liste village, village cliqué, afficher la fiche correspondante */
      $("#block-views-block-recherche-villages-principal-block")
      .find('.views-row')
      .click(function(){
        /* réinitialiser les icones de marquers  */
        $(".leaflet-marker-icon").attr('src',"../../themes/lesvillagesbyca/images/village-icon.png");
        
        var selected_fiche = $(this).find('.fiche');
        selected_fiche.toggle();
        if (selected_fiche.is(":visible")){
            /* changer le marqueur ,en click  */
            $(".leaflet-marker-icon").each(function( ) {
                  if($(this).attr('title')===selected_fiche.find("span[class='fiche-title']").text()){
                   /* alert($(this).attr('title') + " is equal with "+ selected_fiche.find("span[class='fiche-title']").text());*/
     ...
     /* gestion d'évenement sur le marquer cliqué */
      ...
      /* gestion d'évenement sur le popup marqueur en focus */
...
(function ($) {
    $(document).ready(function () {
	    ...
	    $("a.chosen-single > span").css({"margin-top":"4px","font-family": 'Montserrat',"font-size": "14px", "font-weight":"600","line-height":"17px","color":"#C4C4C4","text-align":"center"});
    });
})(jQuery);
;
/**
