...
(function ($) {
    $(document).ready(function () {
		$("#edit_field_thematiques_partenaire_target_id_chosen a.chosen-single > span, #edit_field_thematiques_start_up_target_id_chosen a.chosen-single > span").html("SECTEUR D'ACTIVITÉ");
    });
})(jQuery);
;
/*!
